...
// الدفعة 4 (المهمة 4): يسجّل الزيارة بـ useRecentlyViewed عند نجاح التحميل.

// مسار ملفات PDF المنشورة (اتفاق عضو 5 - القسم 5): public/pdf/{slug}/...
// مبني على import.meta.env.BASE_URL (مو "/" ثابتة) عشان يشتغل صح تحت مسار
// فرعي بـ GitHub Pages — نفس درس مسارات fetch المطلقة من الجولة الماضية.
